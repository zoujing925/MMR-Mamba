...
class EncoderDecoder(nn.Module):
    def __init__(self, cfg=None, criterion=nn.CrossEntropyLoss(reduction='mean', ignore_index=255), norm_layer=nn.BatchNorm2d):
        ...
        self.decode_head = MambaDecoder(img_size=[224, 224], in_channels=self.channels, num_classes=1, embed_dim=self.channels[0], deep_supervision=self.deep_supervision)
