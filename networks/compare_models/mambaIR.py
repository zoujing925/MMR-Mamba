...
class ChannelAttention(nn.Module):
    ...
    def __init__(self, num_feat = 64, squeeze_factor=16):
        super(ChannelAttention, self).__init__()
        # print('num_feat in attention', num_feat, squeeze_factor, num_feat // squeeze_factor)
...
class SS2D(nn.Module):
    def __init__(
        ...
        self.A_logs = self.A_log_init(self.d_state, self.d_inner, copies=4, device=None, merge=True)  # (K=4, D, N)
...
class MambaIR(nn.Module):
    ...
    def __init__(self,
        ...
        if self.upsampler == 'pixelshuffle':
            ...
            # print('upscale', upscale, num_feat)
    ...
    def forward(self, t2, t1):
        ...
        if self.upsampler == 'pixelshuffle':
            ...
            # print('after conv_before_upsample', x.shape)
            x = self.upsample(x)
